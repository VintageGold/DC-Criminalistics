...
**data**: Data from ingesting, wrangling.  
**notebooks**: Notebooks used for ingestion, wrangling, exploratory data analysis, ML, and producing graphs for the technical report.  
